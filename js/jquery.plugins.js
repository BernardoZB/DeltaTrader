...
if (ativo == ".menu-item['/curso-metatrader-5.html']") {
  $("#curso").addClass("current-menu-item");
}
!(function (a, b, c, d) {
  function e(b, c) {
    (this.element = b),
  ...
  var b = function (a, b) {
    ...
    c = function (a, c) {
      ...
      (this.update = function (a) {
        return (
          (a = parseFloat(a)),
          e.animate ? this.renderer.animate(f, a) : this.renderer.draw(a),
          (f = a),
          this
        );
      }.bind(this)),
  ...
  var m = window.MutationObserver || window.WebKitMutationObserver || !1,
    ...
    w = function () {
      ...
      (n.haspointerlock =
        ...
        (n.isie8 =
          n.isie && "documentMode" in document && 8 == document.documentMode),
        (n.isie9 =
          n.isie && "performance" in window && document.documentMode >= 9),
        (n.isie10 =
          n.isie && "performance" in window && 10 == document.documentMode),
        (n.isie11 = "msRequestFullscreen" in o && document.documentMode >= 11),
        (n.isieedge = navigator.userAgent.match(/Edge\/12\./)),
      ...
      return (
        n.ischrome26 && (n.prefixstyle = a[1]),
    ...
    v = function (e, o) {
      ...
      function g(e, o, t) {
        ...
        if (
          ...
          o && v.opt.oneaxismousemode && 0 == r && i && ((r = i), (i = 0), t))
        ) {
          var n =
            0 > r ? v.getScrollLeft() >= v.page.maxw : v.getScrollLeft() <= 0;
          n && ((i = r), (r = 0));
        }
        if (
          (r &&
      ...
      (this.canhwscroll = x.hastransform && v.opt.hwacceleration),
        ...
        (this.debounced = function (e, o, t) {
          ...
          (v.delaylist[e] = o),
            r ||
              (v.debouncedelayed = setTimeout(function () {
                if (v) {
                  var o = v.delaylist[e];
      ...
      (this.getDocumentScrollOffset = function () {
        ...
        (this.updateScrollBar = function (e) {
          if (v.ishwscroll)
            v.rail.css({
              height:
                v.win.innerHeight() -
                (v.opt.railpadding.top + v.opt.railpadding.bottom),
            }),
              v.railh &&
                v.railh.css({
                  width:
                    v.win.innerWidth() -
                    (v.opt.railpadding.left + v.opt.railpadding.right),
                });
          else {
            var o = v.getOffset(),
              t = {
                top: o.top,
                left:
                  o.left - (v.opt.railpadding.left + v.opt.railpadding.right),
              };
        ...
        (this.init = function () {
          ...
          if (
            ...
            v.ispage && (e = v.haswrapper ? v.win : v.doc),
              x.isie9mobile || v.css(e, { "overflow-y": "hidden" }),
              v.ispage &&
                x.isie7 &&
            ...
            for (var h in u)
              (d = u[h]),
                (s = v.opt.railpadding[d]),
                s
                  ? t.css("padding-" + d, s + "px")
                  : (v.opt.railpadding[d] = 0);
            t.append(o),
              (t.width = Math.max(
            ...
            !v.opt.boxzoom ||
              ...
              v.bind(p, "click", v.doZoom),
              v.bind(p, "mouseenter", function () {
            ...
            if (v.opt.horizrailenabled) {
              ...
              o.css({
                ...
                x.isieold && o.css({ overflow: "hidden" }),
                (o.wborder = parseFloat(o.outerWidth() - o.innerWidth())),
                o.addClass("nicescroll-cursors"),
                (v.cursorh = o),
                (f = a(document.createElement("div"))),
                f.attr("id", v.id + "-hr"),
                f.addClass("nicescroll-rails nicescroll-rails-hr"),
                (f.height = Math.max(
                  parseFloat(v.opt.cursorwidth),
                  o.outerHeight()
                )),
                ...
                (f.visibility = !0),
                (f.scrollable = !0),
                (f.align = "top" == v.opt.railvalign ? 0 : 1),
                (v.railh = f),
                (v.railh.drag = !1);
            }
            if (v.ispage)
              t.css({ position: "fixed", top: "0px", height: "100%" }),
                t.align ? t.css({ right: "0px" }) : t.css({ left: "0px" }),
                v.body.append(t),
                v.railh &&
                  (f.css({ position: "fixed", left: "0px", width: "100%" }),
                  f.align ? f.css({ bottom: "0px" }) : f.css({ top: "0px" }),
                  v.body.append(f));
            else {
              if (v.ishwscroll) {
                ...
                a(g).scrollTop(0).scrollLeft(0),
                  ...
                  t.align ? t.css({ right: 0 }) : t.css({ left: 0 }),
                  g.append(t),
                  f &&
                    (f.css({ position: "absolute", left: 0, bottom: 0 }),
                    f.align ? f.css({ bottom: 0 }) : f.css({ top: 0 }),
                    g.append(f));
              } else {
                ...
                v.isfixed || (v.viewport = v.getViewport(v.win[0])),
                  v.viewport &&
                    ((v.body = v.viewport),
                    0 == /fixed|absolute/.test(v.viewport.css("position")) &&
                      v.css(v.viewport, { position: "relative" })),
                  t.css({ position: w }),
                  v.zoom && v.zoom.css({ position: w }),
                  v.updateScrollBar(),
                  v.body.append(t),
                  v.zoom && v.body.append(v.zoom),
                  v.railh && (f.css({ position: w }), v.body.append(f));
              }
              x.isios &&
                v.css(v.win, {
            ...
            if (
              (v.opt.autohidemode === !1
                ...
                : "hidden" == v.opt.autohidemode &&
                  ((v.autohidedom = !1), v.hide(), (v.railslocked = !1)),
              x.isie9mobile)
            ) {
              (v.scrollmom = new b(v)),
              ...
              if (
                    ...
                    if (((v.hasmoving = !1), !v.railslocked)) {
                      ...
                      if (
                        ...
                        !v.rail.scrollable && v.railh.scrollable
                          ? (v.rail.drag.ck = l > 0 ? "v" : !1)
                          : v.rail.scrollable && !v.railh.scrollable
                          ? (v.rail.drag.ck = c > 0 ? "h" : !1)
                          : (v.rail.drag.ck = !1),
                ...
                v.ontouchmove = function (e, o) {
                  ...
                  if (
                    e.targetTouches &&
                    v.opt.preventmultitouchscrolling &&
                  ...
                  if (2 == v.rail.drag.pt) {
                    ...
                    v.ishwscroll && v.opt.bouncescroll
                      ? 0 > h
                        ? (h = Math.round(h / 2))
                        : h > v.page.maxh &&
                          (h = v.page.maxh + Math.round((h - v.page.maxh) / 2))
                      : (0 > h && ((h = 0), (l = 0)),
                        h > v.page.maxh && ((h = v.page.maxh), (l = 0)));
                    var p;
                    v.railh &&
                      v.railh.scrollable &&
                      ((p = v.isrtlmode
                      ...
                      v.ishwscroll && v.opt.bouncescroll
                        ? 0 > p
                          ...
                          : p > v.page.maxw &&
                            (p =
                              v.page.maxw + Math.round((p - v.page.maxw) / 2))
                        : (0 > p && ((p = 0), (d = 0)),
                          p > v.page.maxw && ((p = v.page.maxw), (d = 0))));
                    var m = !1;
                    if (v.rail.drag.dl)
                      (m = !0),
                        "v" == v.rail.drag.dl
                          ? (p = v.rail.drag.sl)
                          : "h" == v.rail.drag.dl && (h = v.rail.drag.st);
                    else {
                      var f = Math.abs(c),
                        g = Math.abs(u),
                      ...
                      (v.synched("touchmove", function () {
                        v.rail.drag &&
                          ...
                          v.railh && v.railh.scrollable
                            ? (v.setScrollLeft(p), v.showCursor(h, p))
                            : v.showCursor(h),
                ...
                ((v.onmousedown = function (e, o) {
                  if (!v.rail.drag || 1 == v.rail.drag.pt) {
                    ...
                    return (
                      ...
                      v.isiframe &&
                        !x.hasmousecapture &&
                        ((v.saved.csspointerevents = v.doc.css(
                          "pointer-events"
                        )),
              ...
              x.hasw3ctouch
                ? (v.css(v.rail, { "touch-action": "none" }),
                  ...
                  v.bind(document, "pointermove", v.ontouchmove))
                : x.hasmstouch
                ...
                (v.opt.cursordragontouch ||
                  ...
                  v.jqbind(v.rail, "mouseenter", function () {
                    return v.ispage || v.win.is(":visible")
                  ...
                  switch (n) {
                    ...
                    case 32:
                      v.opt.spacebarenabled &&
                        (l ? v.doScrollBy(v.view.h) : v.doScrollBy(-v.view.h),
                        (c = !0));
                      break;
                    case 27:
            ...
            (v.onAttributeChange = function (e) {
              ...
              m !== !1 &&
                ((v.observerbody = new m(function (e) {
                  return (
                    e.forEach(function (e) {
                      return "attributes" == e.type
                        ? a("body").hasClass("modal-open") &&
                          !a.contains(a(".modal-dialog")[0], v.doc[0])
                          ? v.hide()
                          : v.show()
                        : void 0;
                    }),
                    document.body.scrollHeight != v.page.maxh
                      ? v.lazyResize(30)
                      : void 0
                  );
                })),
              ...
              v.istextarea &&
                (v.bind(v.win, "keydown", v.lazyResize),
                v.bind(v.win, "mouseup", v.lazyResize)),
              v.lazyResize(30);
          }
          if ("IFRAME" == this.doc[0].nodeName) {
            var E = function () {
              ...
              v.lazyResize(30),
                ...
                v.opt.enablemousewheel &&
                  v.bind(e, "mousewheel", v.onmousewheel),
                v.opt.enablekeyboard &&
        ...
        (this.showCursor = function (e, o) {
          if (
            ...
            if (
              ...
              var t = v.hasreversehr
                ? v.scrollvaluemaxw - v.scroll.x
                : v.scroll.x;
              !v.rail.align && v.rail.visibility
                ...
                : v.cursorh.css({ width: v.cursorwidth, left: t }),
                (v.cursoractive = !0);
            }
        ...
        (this.onResize = function (e, o) {
          ...
          if (
            ...
            0 == v.page.maxw
              ? (v.hideRailHr(),
                ...
                (v.cursorwidth = 0),
                v.setScrollLeft(0),
                v.railh && (v.railh.scrollable = !1))
              : ((v.page.maxw -=
                  v.opt.railpadding.left + v.opt.railpadding.right),
                v.railh && (v.railh.scrollable = v.opt.horizrailenabled)),
            (v.railslocked =
          ...
          v.hidden || v.visibility
            ? !v.railh || v.hidden || v.railh.visibility || v.showRailHr()
        ...
        (this.show = function () {
          return (
            (v.hidden = !1), (v.railslocked = !1), v.showRail().showRailHr()
          );
        }),
        (this.hide = function () {
          return (
            (v.hidden = !0), (v.railslocked = !0), v.hideRail().hideRailHr()
          );
        }),
        ...
        (this.remove = function () {
          v.stop(),
            ...
            v.debouncedelayed && clearTimeout(v.debouncedelayed),
            v.doZoomOut(),
            v.unbindAll(),
            x.isie9 &&
        ...
        (this.onmousewheel = function (e) {
          if (!v.wheelprevented) {
            if (v.railslocked)
              return v.debounced("checkunlock", v.resize, 250), !0;
                        ...
                        : void (v.timer = setTimeout(function () {
                            ...
                            if (
                              ...
                              var a = t,
                                c = r;
                              (v.timerscroll = {
                                bz: new z(a, v.newscrolly, s, 0, 0, 0.58, 1),
                                bh: new z(c, v.newscrollx, s, 0, 0, 0.58, 1),
                              }),
                                v.cursorfreezed ||
    ...
    (($.fn.caroufredsel = $.fn.carouFredSel = function (options, configs) {
      ...
      (FN._init = function (a, b, c) {
          ...
          switch (
            ...
            case "right":
              "variable" != opts[opts.d.width] &&
                ((opts = in_getAlignPadding(opts, d)), (opts.usePadding = !0));
              break;
            default:
              (opts.align = !1),
                (opts.usePadding =
          ...
          FN._unbind_events(),
            $cfs.bind(cf_e("stop", conf), function (a, b) {
              return (
                ...
                (crsl.isStopped = !0),
                opts.auto.play &&
                  ((opts.auto.play = !1), $cfs.trigger(cf_e("pause", conf), b)),
                !0
              );
            }),
            $cfs.bind(cf_e("finish", conf), function (a) {
              return (
                a.stopPropagation(), crsl.isScrolling && sc_stopScroll(scrl), !0
              );
            }),
            ...
            $cfs.bind(cf_e("prev", conf) + " " + cf_e("next", conf), function (
              a,
              b,
              c,
              d,
              ...
              if (!is_number(c)) {
                if ("*" != opts.items.filter) c = "visible";
                  ...
                  for (
                    var k = [c, b.items, opts[j].items], i = 0, l = k.length;
                    l > i;
                    i++
                  )
                    if (
              ...
              return (
                (i =
                  c > b
                    ? h.slice(b, c)
                    : $(
                        h.slice(b, itms.total).get().concat(h.slice(0, c).get())
                      )),
        ...
        (FN._bind_buttons = function () {
          ...
          if (
            (opts.auto.button &&
              opts.auto.button.bind(cf_e(opts.auto.event, conf, !1), function (
                a
              ) {
                a.preventDefault();
                var b = !1,
            ...
            opts.prev.button &&
              (opts.prev.button.bind(cf_e(opts.prev.event, conf, !1), function (
                a
              ) {
          ...
          if (
            opts.next.button &&
            (opts.next.button.bind(cf_e(opts.next.event, conf, !1), function (
              a
            ) {
